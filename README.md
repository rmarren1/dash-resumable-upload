...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-resumable-upload -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-resumable-upload to your layout, then run it:
